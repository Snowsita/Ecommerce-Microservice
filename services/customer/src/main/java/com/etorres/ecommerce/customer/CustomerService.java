...
import com.etorres.ecommerce.exceptions.CustomerNotFoundException;
...
public class CustomerService {
    ...
    public CustomerResponse findById(String customerId) {
        return repository.findById(customerId).map(mapper::toCustomerResponse).orElseThrow(() -> new CustomerNotFoundException(format("No customer found with the provided ID:: %s", customerId)));
    }
